...
class header_reader(gr.sync_block):  # other base classes are basic_block, decim_block, interp_block
    ...
    def __init__(self, header_byte_length=2, preamble_byte_length = 5, tag_name = "header_start", payload_byte_length = 10):  # only default arguments here
    ...
    def work(self, input_items, output_items):
        ...
        for tag in tags:
            ...
            packet_number = int(char, 2)
            print("Packet number:", packet_number)
            self.add_item_tag(0, tag.offset, pmt.intern("step"), pmt.to_pmt(np.int64(packet_number)))
